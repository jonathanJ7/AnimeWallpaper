...
public class Generos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(consulta != null){
            ...
            DataGeneroReducido detalleGenero = port.detalleGenero(consulta);
            request.setAttribute("detalleGenero", detalleGenero);
            request.getRequestDispatcher( "/generoDetalle.jsp").forward(request,response);
        }else{
